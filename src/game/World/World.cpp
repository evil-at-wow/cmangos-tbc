...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfigMinMax(CONFIG_UINT32_PLAYER_NOXP_LEVEL1, "NoXPPlayerLevel1", DEFAULT_MAX_LEVEL, 1, DEFAULT_MAX_LEVEL);
    setConfigMinMax(CONFIG_UINT32_PLAYER_NOXP_LEVEL2, "NoXPPlayerLevel2", DEFAULT_MAX_LEVEL, 1, DEFAULT_MAX_LEVEL);
    setConfigMinMax(CONFIG_UINT32_PLAYER_NOXP_LEVEL3, "NoXPPlayerLevel3", DEFAULT_MAX_LEVEL, 1, DEFAULT_MAX_LEVEL);
    ...
    VMAP::VMapFactory::GetVMapManager().setEnableLineOfSightCalc(enableLOS);
    VMAP::VMapFactory::GetVMapManager().setEnableHeightCalc(enableHeight);
